...
void yield(void) __attribute__ ((weak, alias("unused_void")));
void _kill(void) __attribute__ ((weak, alias("unused_void")));
void _getpid(void) __attribute__ ((weak, alias("unused_void")));
