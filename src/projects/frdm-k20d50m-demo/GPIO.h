...
#define LED1_PORT   C   // Red LED
#define LED1_BIT    3

#define LED2_PORT   D    // Green LED
#define LED2_BIT    4

#define LED3_PORT   A    // Blue
#define LED3_BIT    2
...
#define LED3_OFF       LED3_PCOR(LED3_PORT,LED3_BIT) //Led turn with positive
#define LED3_ON        LED3_PSOR(LED3_PORT,LED3_BIT)
